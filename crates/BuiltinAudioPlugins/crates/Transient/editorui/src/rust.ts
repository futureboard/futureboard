 ...
 *
 * The editor duplicates a handful of Rust constants — parameter ids and
 * ranges. Duplication is unavoidable (the editor is a separate bundle), so
 * the tests parse the real `.rs` files and compare, which turns a silent
