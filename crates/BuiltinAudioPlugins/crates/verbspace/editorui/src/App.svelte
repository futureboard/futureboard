...
<div class="app">
  ...
  <div class="body">
    ...
    <div class="rack">
      <section class="group" aria-label="Space">
...
<style>
  ...
  .chrome {
    ...
    background: linear-gradient(180deg, #18141f 0%, var(--panel) 100%);
  }
